      ...
      <nav className="p-4 w-full">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            <span className="text-[#ffffff] text-[14px] hover:text-[#cccccc] font-[#Montserrat]">Login</span>
      ...
      <div className="flex flex-col items-center gap-10 mt-8 sm:mt-16">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 space-x-0 sm:space-x-4 mt-10 justify-center items-center">
            <button className="bg-[#23A6F0] text-[#FFFFFF] px-6 py-2 rounded font-[#Montserrat]">Get Quote Now</button>
            <button className="border border-[#23A6F0] text-[#23A6F0] px-6 py-2 rounded font-[#Montserrat]">Learn More</button>
          </div>
        </div>
